    ...
    <div className="mx-auto max-w-6xl px-4 py-12">
      <header className="mb-10">
        <Badge variant="outline" className="mb-4">
          PFE 2024–2025 · Télécom SudParis
        </Badge>
        <h1 className="text-3xl font-bold leading-tight">
          Partial Reproduction of Depth Anything V2: Monocular Depth Estimation via
          Knowledge Distillation
        </h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Keywords: monocular depth estimation &middot; knowledge distillation &middot; Vision
          Transformer &middot; DPT &middot; synthetic-to-real transfer
        </p>
      </header>
        ...
        <div className="min-w-0 flex-1 space-y-16">
          ...
          <section id="references" className="scroll-mt-20">
            ...
            <ol className="list-inside list-decimal space-y-2 text-sm text-muted-foreground">
              <li>
                Yang et al. (2024).{" "}
                <em>Depth Anything V2.</em> NeurIPS 2024. arXiv:2406.09414.
              </li>
              <li>
                Yang et al. (2024).{" "}
                <em>
              ...
              <li>
                Ranftl et al. (2021).{" "}
                <em>Vision Transformers for Dense Prediction (DPT).</em> ICCV 2021.
              </li>
              <li>
                Ranftl et al. (2022).{" "}
                <em>
                  Towards Robust Monocular Depth Estimation: Mixing Datasets for
                  Zero-Shot Cross-Dataset Transfer (MiDaS).
                </em>{" "}
                TPAMI 2022.
              </li>
            </ol>
