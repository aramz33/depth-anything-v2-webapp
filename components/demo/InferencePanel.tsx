...
async function runPrediction(imageBase64: string): Promise<Result & { original: string }> {
      ...
      {result && !loading && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="mb-2 text-xs text-muted-foreground">Grayscale depth</p>
            ...
            <div>
              <p className="mb-2 text-xs text-muted-foreground">Colorized depth</p>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
